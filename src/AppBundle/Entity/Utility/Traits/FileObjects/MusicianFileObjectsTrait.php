<?php
// src/AppBundle/Entity/Utility/Traits/FileObjects/MusicianFileObjectsTrait.php
...
trait MusicianFileObjectsTrait
{
    /**
     * @Assert\File(
     *     maxSize="10M",
     ...
     * )
     *
     * @Vich\UploadableField(mapping="musician_photo", fileNameProperty="photoName")
     */
    protected $photoFile;
